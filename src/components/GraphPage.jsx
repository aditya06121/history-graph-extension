...
function GraphPage() {
  ...
  useEffect(() => {
    ...
    chrome.windows.getCurrent((currentWindow) => {
      ...
      // Listen for changes to graph data in chrome storage
